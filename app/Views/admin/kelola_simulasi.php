...
<body class="p-6 font-sans text-gray-700 pb-28">
    ...
    <a href="/admin/tambah_simulasi" class="neu-btn-blue block text-center text-white font-bold py-4 rounded-2xl mb-8 transition">
        <i data-lucide="plus-circle" class="inline w-4 h-4 mr-1"></i> Tambah Skenario Simulasi Baru
    </a>
            ...
            <?php foreach ($daftar_simulasi as $simulasi): ?>
                <div class="neu-flat p-5 rounded-2xl flex justify-between items-center">
                    ...
                    <div class="flex space-x-3 ml-4">
                        <a href="/admin/edit_simulasi/<?= $simulasi['id_skenario'] ?>" class="w-10 h-10 neu-flat rounded-full flex items-center justify-center text-blue-500 hover:text-blue-700 active:neu-pressed"><i data-lucide="square-pen" class="w-4 h-4"></i></a>
                        <a href="/admin/hapus_simulasi/<?= $simulasi['id_skenario'] ?>" onclick="return confirm('Yakin ingin menghapus skenario ini permanen?')" class="w-10 h-10 neu-flat rounded-full flex items-center justify-center text-red-500 hover:text-red-700 active:neu-pressed"><i data-lucide="trash-2" class="w-4 h-4"></i></a>
                    </div>
                    <a href="/admin/laporan_simulasi/<?= $simulasi['id_skenario'] ?>"
                        class="flex items-center gap-1 text-[10px] bg-teal-100 text-teal-600 px-3 py-1.5 rounded-lg font-bold hover:bg-teal-200 transition">
                        <i data-lucide="chart-column" class="w-3 h-3"></i>
                        Laporan Siswa
