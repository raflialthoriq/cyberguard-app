...
<head>
    ...
    <title>Pengguna - CyberGuard</title>
    ...
    <div class="max-w-5xl mx-auto px-2 md:px-6 py-3 flex justify-between items-center text-center">
        ...
        <div class="flex-1 relative flex flex-col items-center cursor-pointer group" onclick="document.getElementById('menuAkses').classList.toggle('hidden'); event.stopPropagation();">
            ...
            <div id="menuAkses" class="hidden absolute bottom-full left-1/2 transform -translate-x-1/2 mb-3 bg-white rounded-2xl shadow-xl border border-gray-200 w-36 py-2 flex flex-col z-50 transition-all">
                ...
                <a href="/admin/manajemen_pengguna" class="flex items-center px-4 py-3 text-xs font-bold text-blue-600 hover:text-blue-600 hover:bg-blue-50 transition border-b border-blue-100">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm font-bold text-gray-500">
                Pantau dan kelola akses akun guru dan siswa.
            </p>
        </div>
    </div>

    <?php if (session()->getFlashdata('pesan')): ?>
        <div class="bg-white/50 border-l-4 border-blue-500 text-blue-700 p-4 rounded-xl mb-6 text-sm font-bold neu-flat flex items-center gap-2">
                ...
                <?php foreach ($daftar_pengguna as $p): ?>
                    <tr class="border-b border-gray-300/50 hover:bg-white/30 transition">
                        ...
                        <td class="py-4 px-4 text-center">
                            ...
                            <?php else: ?>
                                <a href="/admin/toggle_status_pengguna/<?= $p['id_pengguna'] ?>"
                                    onclick="return confirm('Aktifkan kembali akun ini?')"
                                    class="inline-flex items-center gap-2 bg-green-100 text-green-600 px-3 py-2 rounded-lg text-xs font-bold hover:bg-green-200 transition">
