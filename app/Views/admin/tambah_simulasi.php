...
<head>
    ...
    <title>Tambah Simulasi CBT - CyberGuard</title>
...
<body class="flex flex-col min-h-screen font-sans text-gray-700 pb-28">
    ...
    <div class="p-6 flex items-center mb-2">
        <a href="/admin/kelola_simulasi" class="neu-flat w-10 h-10 flex items-center justify-center rounded-full text-blue-600 mr-4 hover:text-blue-700"><i data-lucide="arrow-left" class="w-5 h-5"></i></a>
        <h1 class="text-xl font-extrabold text-gray-700 tracking-wide flex items-center gap-2"><i data-lucide="file-pen-line" class="w-6 h-6 text-orange-500"></i>Skenario Baru</h1>
    </div>

    <div class="px-6">
        <form action="/admin/simpan_simulasi" method="POST" class="space-y-6">

            <div class="neu-flat p-6 rounded-3xl space-y-4 border-l-4 border-blue-500">
                <h2 class="font-bold text-blue-600">1. Kasus Utama</h2>
                <input type="text" name="judul_simulasi" placeholder="Judul Kasus (Misal: Foto Editan)" class="neu-pressed w-full px-5 py-4 rounded-2xl focus:outline-none" required>
                <textarea name="deskripsi_kasus" placeholder="Ceritakan situasi kasus di sini..." class="neu-pressed w-full p-5 rounded-2xl focus:outline-none resize-none h-24" required></textarea>
            </div>

            <div id="wadah-opsi" class="space-y-6">
                <!-- Opsi default pertama -->
                <div class="opsi-item neu-flat p-6 rounded-3xl space-y-4">
                    <div class="flex justify-between items-center mb-2">
                        <h2 class="font-bold text-gray-600 label-opsi">Opsi Jawaban</h2>
                        <button type="button"
                    ...
                    <textarea name="feedback_opsi[]" placeholder="Feedback CBT (Penjelasan psikologis jika siswa memilih ini)" class="neu-pressed w-full p-3 rounded-xl focus:outline-none resize-none" required></textarea>
