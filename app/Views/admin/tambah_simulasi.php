...
<body class="flex flex-col min-h-screen font-sans text-gray-700 pb-28">
    ...
    <div class="p-6 flex items-center mb-2">
        <a href="/admin/kelola_simulasi" class="neu-flat w-10 h-10 flex items-center justify-center rounded-full text-blue-600 font-bold mr-4">←</a>
        <h1 class="text-xl font-extrabold text-gray-700 tracking-wide">Skenario Dinamis Baru</h1>
    </div>
