...
<body class="flex flex-col min-h-screen font-sans text-gray-700 pb-28">
    ...
    <div class="p-6 flex items-center mb-2">
        <a href="/admin/kelola_modul" class="neu-flat w-10 h-10 flex items-center justify-center rounded-full text-blue-600 active:neu-pressed mr-4">
            ...
            <?php else: ?>
                <?php foreach ($daftar_soal as $index => $soal): ?>
                    <div class="neu-flat p-5 rounded-2xl relative">
                        <a href="/admin/hapus_kuis/<?= $soal['id_soal'] ?>"
                            onclick="return confirm('Hapus soal ini?')"
                            class="absolute top-4 right-4 w-8 h-8 neu-flat rounded-full flex items-center justify-center text-red-500 active:neu-pressed">
