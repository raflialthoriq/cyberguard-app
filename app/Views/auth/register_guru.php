...
<head>
    ...
    <style>
        ...
        .neu-btn-green {
            ...
            box-shadow: 4px 4px 8px rgba(16, 185, 129, 0.4), -4px -4px 8px rgba(255, 255, 255, 1);
        }
    </style>
</head>
...
<body class="flex items-center justify-center min-h-screen font-sans text-gray-700 px-6 py-10">
    ...
    <div class="neu-flat p-8 rounded-[40px] w-full max-w-sm">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-extrabold text-gray-800">Buat Akun Guru</h1>
        ...
        <form action="/auth/register_proses/guru" method="POST" class="space-y-4">
            ...
            <input type="text" name="nip" placeholder="NIP" class="neu-pressed w-full px-5 py-4 rounded-2xl focus:outline-none" required>
            <!-- Dropdown Pilihan Sekolah Dinamis -->
            <select name="nama_sekolah" class="neu-pressed w-full px-5 py-4 rounded-2xl focus:outline-none text-sm bg-transparent" required>
            ...
            <!-- PROTEKSI KEAMANAN GURU -->
            <div class="border-l-4 border-red-500 pl-4 py-2 mt-4">
                <label class="text-xs font-bold text-red-500">Kode Otorisasi Sekolah</label>
                <input type="password" name="kode_rahasia" placeholder="Masukkan Token Sekolah" class="neu-pressed w-full px-5 py-3 mt-1 rounded-xl focus:outline-none text-red-500" required>
            </div>

            <!-- kode_rahasia: BK-CYBER-2026 -->

            <button type="submit" class="neu-btn-green w-full text-white font-bold py-4 rounded-2xl mt-4">Daftar Akun Guru</button>
        </form>
