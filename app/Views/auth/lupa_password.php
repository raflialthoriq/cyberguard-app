...
<body class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md neu-flat p-8 rounded-3xl border border-white/40">
        <div class="text-center mb-6">
            <h1 class="text-xl font-black text-gray-800 flex items-center justify-center gap-2"> Pemulihan Akun
        ...
        <form action="/auth/proses_lupa_password" method="POST" class="space-y-4">
            ...
            <button type="submit"
                class="w-full bg-blue-600 text-white font-bold py-3 rounded-xl text-xs shadow-md hover:bg-blue-700 transition active:scale-95 flex items-center justify-center gap-2">
