...
<head>
    ...
    <title>Panduan Fasilitator - CyberGuard</title>
...
<body class="pb-28 p-4 p-6 font-sans text-gray-700 min-h-screen flex flex-col relative">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-extrabold text-gray-800 tracking-wide flex items-center gap-3">
                <i data-lucide="library-big" class="w-7 h-7 text-green-600"></i>
                Pustaka Panduan
            </h1>
    ...
    <div class="mb-8">
        <div class="neu-pressed flex items-center px-5 py-3 rounded-2xl w-full">
            ...
            <input
                type="text"
                placeholder="Cari topik diskusi, materi, atau panduan..."
                class="bg-transparent focus:outline-none w-full text-sm font-bold text-gray-600">
        </div>
    </div>

    <div class="space-y-4">
        <?php foreach ($daftar_panduan as $p): ?>
            <div class="neu-flat p-5 rounded-2xl flex items-center justify-between group hover:bg-orange-50/20 hover:-translate-y-1 hover:shadow-xl transition duration-300">
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 rounded-2xl neu-pressed flex items-center justify-center">
                        <i data-lucide="book-open-text" class="w-6 h-6 text-orange-500"></i>
                    </div>
                    <div>
                        <div class="flex items-center gap-2"><i data-lucide="bookmark" class="w-3 h-3 text-orange-500"></i><span class="text-[8px] font-black text-gray-500 uppercase tracking-widest"><?= esc($p['kode_panduan']) ?> - Reference Material</span>
                        </div>
                ...
                <div class="flex gap-2 mt-3 md:mt-0">
                    <a href="/guru/baca_panduan/<?= $p['id_panduan'] ?>"
                        class="bg-indigo-600 text-white text-xs font-bold px-4 py-2 rounded-xl shadow-sm hover:bg-indigo-700 transition flex items-center gap-2">
